...
See git history for `internal/sqlite/premigrate.go` (the natural-key slot migration
retired in this PR; spec at `docs/superpowers/specs/2026-05-25-natural-key-slots-design.md`)
